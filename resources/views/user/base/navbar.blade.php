    ...
    <div class="container">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="../../index.html"><img
                    src="../../../../images/logo-white.svg" alt="logo"/></a>
                ...
                <li class="nav-item nav-language dropdown">
                    <a class="nav-link count-indicator dropdown-toggle d-flex justify-content-center align-items-center"
                       id="languageDropdown" href="#" data-toggle="dropdown">
                        <i class="flag-icon flag-icon-au mx-0" title="au" id="au"></i>
                        <p class="mb-0 ml-1">Aus</p>
                        <i class="mdi mdi-unfold-more-horizontal mx-0"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
